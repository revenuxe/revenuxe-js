...
const DialogContent = React.forwardRef<React.ElementRef<typeof DialogPrimitive.Content>, React.ComponentPropsWithoutRef<typeof DialogPrimitive.Content>>(({
  ...
  ...props
    ...
    <DialogOverlay />
    <DialogPrimitive.Content ref={ref} className={cn("fixed inset-x-0 top-1/2 z-50 grid w-[calc(100%-2rem)] max-w-lg -translate-y-1/2 mx-auto gap-4 border bg-background p-5 shadow-lg duration-200 rounded-2xl data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95", className)} {...props}>
      {children}
