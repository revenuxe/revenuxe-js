        ...
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-6">
            ...
            <Button 
              size="lg" 
              variant="outline"
              className="border-2 border-primary/30 hover:bg-primary/10 px-12 py-7 text-lg font-bold"
            >
              SCHEDULE A CALL
            </Button>
          </div>
          ...
          <div className="pt-12 flex flex-wrap justify-center gap-8 text-center">
            ...
            <div className="w-px bg-border" />
            <div>
              <div className="text-3xl md:text-4xl font-bold text-primary">5+ Years</div>
