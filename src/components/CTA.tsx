...
const CTA = () => {
  ...
  return <section className="py-24 relative overflow-hidden bg-primary">
      {/* Pattern */}
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-6">
            <Button size="lg" className="bg-white text-primary hover:bg-white/90 px-12 py-7 text-lg font-bold shadow-2xl w-full sm:w-auto" onClick={handleCall}>
              <Phone className="mr-2 w-5 h-5" />
              CALL NOW
            </Button>
            <Button size="lg" className="bg-green-600 hover:bg-green-700 text-white px-12 py-7 text-lg font-bold w-full sm:w-auto" onClick={handleWhatsApp}>
