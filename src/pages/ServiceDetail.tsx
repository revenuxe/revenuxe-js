...
const additionalServices = {
  ...
  "ai-voice-video": {
    ...
    subtitle: "Deploy intelligent conversational AI agents for customer interactions",
    description: "Transform customer experience with AI-powered voice and video agents that handle inquiries, provide support, and drive conversions — 24/7 without human intervention.",
    features: [
      { title: "AI Voice Assistants", description: "Deploy intelligent voice bots that handle phone calls, answer questions, and route conversations naturally.", link: "/sub-services/ai-voice-assistants" },
      { title: "Video AI Support", description: "Interactive video agents that guide customers through products, troubleshooting, and onboarding visually.", link: "/sub-services/video-ai-support" },
      { title: "Call Center AI", description: "Replace or augment call centers with AI that handles high call volumes with consistent quality.", link: "/sub-services/call-center-ai" },
      { title: "Multilingual Voice AI", description: "Serve global customers in 50+ languages with natural-sounding AI voice agents.", link: "/sub-services/multilingual-voice-ai" },
    ],
    benefits: ["24/7 availability", "90% cost reduction vs human agents", "Instant response times", "Consistent quality", "Scalable to millions of calls", "Multilingual support"],
    process: [
      { step: "Use Case Analysis", description: "Identify key customer interaction points suited for AI agents." },
      { step: "Agent Design", description: "Design conversational flows, voice personality, and response logic." },
      { step: "Training & Testing", description: "Train AI on your products, FAQs, and brand voice with thorough testing." },
      { step: "Deploy & Optimize", description: "Launch agents and continuously improve from real interaction data." },
    ],
  },
