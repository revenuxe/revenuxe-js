  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        description="Read Revenuxe's terms and conditions for software development services. Understand our service agreements, payment terms, client responsibilities, and business policies."
        keywords="Revenuxe terms and conditions, software development service agreement, SaaS development terms"
      ...
      <main className="container mx-auto px-4 pb-16">
        <article className="max-w-4xl mx-auto prose prose-lg">
          ...
          <section className="mb-8">
            ...
            <p className="text-foreground/80">
              Revenuxe provides software development services including SaaS development, web application development,
              AI systems, custom software, websites, platform modernization, and related engineering support. Specific
              deliverables and timelines will be outlined in individual service agreements.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 text-foreground/80 space-y-2">
              ...
              <li>Grant necessary access to platforms, repositories, systems, and accounts</li>
              <li>Review and approve deliverables within agreed timeframes</li>
              <li>Make payments according to the agreed schedule</li>
              <li>Ensure all provided content, data, and assets comply with applicable laws</li>
            </ul>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-foreground/80">
              ...
              Revenuxe retains rights to methodologies, reusable components, templates, and pre-existing materials.
          ...
          <section className="mb-8">
            ...
            <p className="text-foreground/80">
              ...
              delivering or receiving services. This obligation continues after the termination of the agreement.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-foreground/80">
              ...
              commercial outcomes from software, websites, or platform launches as results depend on product-market fit,
              usage, operations, and other external factors.
            </p>
          </section>
