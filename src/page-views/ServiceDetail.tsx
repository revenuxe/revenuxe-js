...
const additionalServices: Record<string, any> = {
  ...
  "conversion-rate-optimization": {
    ...
    subtitle: "Turn more visitors into leads, customers, and booked calls",
    description: "Improve the performance of your existing traffic with funnel analysis, landing page testing, form optimization, offer clarity, and data-led UX improvements.",
    features: [
      { title: "Funnel Audit", description: "Identify where visitors drop off across landing pages, forms, calls to action, and checkout or booking flows.", link: "/sub-services/conversion-optimization" },
      { title: "A/B Testing Roadmap", description: "Prioritize page, copy, offer, and layout tests based on traffic quality and conversion impact.", link: "/sub-services/ab-testing" },
      { title: "Landing Page Improvements", description: "Refine messaging, structure, trust signals, and forms to reduce friction and increase lead quality.", link: "/sub-services/conversion-design" },
    ],
    benefits: ["Higher lead conversion", "Lower cost per acquisition", "Better landing page performance", "Cleaner funnel insights", "Stronger offer clarity", "More value from existing traffic"],
    process: [
      { step: "Audit", description: "Review analytics, heatmaps, page structure, forms, and conversion paths." },
      { step: "Prioritize", description: "Build a test roadmap around the highest-impact friction points." },
      { step: "Improve", description: "Update copy, layout, CTAs, forms, and tracking." },
      { step: "Measure", description: "Compare results and keep improving the winning paths." },
    ],
  },
  "growth-marketing": {
    title: "Growth Marketing",
    subtitle: "Experiment, learn, and scale the channels that actually move revenue",
    description: "Build a structured growth engine across acquisition, activation, conversion, retention, and reporting with focused experiments and measurable outcomes.",
    features: [
      { title: "Growth Experiments", description: "Plan and run controlled tests across channels, offers, landing pages, and audience segments.", link: "/sub-services/growth-marketing" },
      { title: "Funnel Optimization", description: "Improve each stage from first visit to qualified lead, purchase, retention, or repeat engagement.", link: "/sub-services/funnel-optimization" },
      { title: "Channel Scaling", description: "Find the campaigns and organic plays worth scaling while cutting low-performing activity.", link: "/sub-services/organic-growth" },
    ],
    benefits: ["Faster learning cycles", "Clearer channel priorities", "Better budget allocation", "Improved acquisition quality", "More repeatable growth", "Stronger revenue visibility"],
    process: [
      { step: "Diagnose", description: "Review current channels, funnel metrics, audience segments, and constraints." },
      { step: "Plan", description: "Select experiments with clear hypotheses, owners, timelines, and success metrics." },
      { step: "Launch", description: "Run campaigns and funnel improvements with clean tracking." },
      { step: "Scale", description: "Double down on winners and turn insights into a repeatable growth system." },
    ],
  },
  "marketing-automation": {
    title: "Marketing Automation",
    subtitle: "Automate follow-up, nurturing, and lead handling without losing the human touch",
    description: "Connect your forms, CRM, email journeys, lead scoring, and reporting so prospects get timely communication and your team gets cleaner handoffs.",
    features: [
      { title: "Lead Nurture Workflows", description: "Create automated email and CRM sequences for new inquiries, abandoned forms, and re-engagement.", link: "/sub-services/marketing-automation" },
      { title: "CRM & Form Integration", description: "Connect website forms, lead sources, tags, stages, and notifications into a cleaner pipeline.", link: "/sub-services/conversion-tracking" },
      { title: "Lifecycle Campaigns", description: "Build segmented journeys for prospects, customers, upsells, and retention.", link: "/sub-services/email-campaigns" },
    ],
    benefits: ["Faster lead follow-up", "Better pipeline visibility", "More consistent nurturing", "Reduced manual work", "Higher email engagement", "Cleaner sales handoffs"],
    process: [
      { step: "Map", description: "Document lead sources, stages, messages, and ownership." },
      { step: "Connect", description: "Integrate forms, CRM, email tools, and conversion events." },
      { step: "Automate", description: "Build workflows, rules, segments, and notifications." },
      { step: "Optimize", description: "Improve timing, copy, segmentation, and reporting from real data." },
    ],
  },
  "marketing-attribution": {
    title: "Marketing Attribution",
    subtitle: "Understand which channels, campaigns, and journeys create real pipeline",
    description: "Set up attribution, conversion tracking, reporting, and channel analysis so marketing decisions are based on revenue signals instead of guesswork.",
    features: [
      { title: "Attribution Model Setup", description: "Map how organic, paid, email, social, and referral touchpoints contribute to conversions.", link: "/sub-services/marketing-attribution" },
      { title: "Conversion Tracking", description: "Track form submissions, calls, booked meetings, purchases, and key funnel events accurately.", link: "/sub-services/conversion-tracking" },
      { title: "Performance Dashboards", description: "Build reports that show channel quality, cost, revenue influence, and campaign trends.", link: "/sub-services/custom-dashboards" },
    ],
    benefits: ["Clearer ROI reporting", "Better spend decisions", "Cleaner conversion data", "Improved channel comparison", "Less reporting guesswork", "Stronger campaign accountability"],
    process: [
      { step: "Audit", description: "Review tracking, UTMs, CRM fields, analytics setup, and reporting gaps." },
      { step: "Define", description: "Choose attribution logic, conversion events, and channel naming rules." },
      { step: "Implement", description: "Set up tracking, dashboards, source mapping, and QA." },
      { step: "Report", description: "Turn attribution data into budget and strategy recommendations." },
    ],
  },
  "web-development": {
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-5">
                {service.features?.map((f: any, i: number) => (
                  ...
                  >
                    ...
                    {f.link && (
                      <Link href={f.link} className="absolute top-5 right-5 md:top-7 md:right-7">
